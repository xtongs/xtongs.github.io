    ...
    <div className="ad-Foot">
      <ul className="ad-Foot-list">
        <li className="ad-Foot-item">
          <span className="ad-Foot-highlight">Click</span> to select a
                    point
                </li>
        <li className="ad-Foot-item">
          <span className="ad-Foot-highlight">Ctrl + Click</span> to
                    add a point
                </li>
      </ul>
      <div className="ad-Foot-meta">
        <a href="https://codepen.io/anthonydugois/pen/mewdyZ">Forked from a pen by Anthony Dugois</a>
      </div>
    </div>
  );
}
...
function Grid(props) {
  ...
  return (
    <g className={"ad-Grid" + (!show ? "  is-hidden" : "")}>
      {grid}
    </g>
  );
}
